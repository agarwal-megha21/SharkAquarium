                ...
                <body>
                    ...
                    <section class="container">
                        <div class="form-container" style="align-items: left; margin-left: 0px; margin-right: 800px; width: 800px;" >
                            <form method="POST" action="/createBuyOrder" model="order" class="form-signin" style="margin-top: 100px;margin-right: 0px; background-color: rgba(255,255,255,0.64); margin-left: 500px;">
